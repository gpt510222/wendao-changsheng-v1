...
applyServerSect=function(result={}){const sect=result.sect||result;if(sect.sectExperienceBonus!=null)state.serverSectExperienceBonus=Math.max(0,Math.min(.5,Number(sect.sectExperienceBonus)||0));return applyServerSectBase(result)};
