...
async function playerSectBootstrap(){const channel=leaderboardConfig.sessionKey.includes('release')?'formal':'test';applyServerSect(await playerStateRpc('player_sect_bootstrap',{p_channel:channel,p_rank:state.sectRank||0,p_acting_leader:!!state.actingLeader}));return applyServerSect(await playerStateRpc('player_sect_membership_bootstrap',{p_channel:channel,p_sect_name:state.sect||'',p_sect_star:state.sectStar||0,p_sect_faction:state.sectFaction||''}))}
