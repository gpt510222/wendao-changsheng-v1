...
async function playerCombatLoadoutBootstrap(){const channel=leaderboardConfig.sessionKey.includes('release')?'formal':'test';return applyServerCombatLoadout(await playerStateRpc('player_combat_loadout_bootstrap',{p_channel:channel,p_legacy_embryo:state.swordEmbryo||'',p_legacy_moves:state.swordMoves||[]}))}
