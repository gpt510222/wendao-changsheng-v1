...
async function startNpcBattle(n,mode='spar'){
  ...
  battle={active:true,resolved:false,mode,sectSparAttemptId:sparTicket?.attemptId||null,round:1,completedRounds:0,playerMoveIndex:0,player:{...player,hp:player.maxHp},enemy:{...enemy,hp:enemy.maxHp,name:n.name,npc:n,race:'human'},logs:[]};
