...
begin
  ...
  delete from public.arena_daily where user_id=new_user and channel='formal';
  ...
  update public.arena_profiles set user_id=new_user where user_id=old_user and channel='formal';
  update public.arena_daily set user_id=new_user where user_id=old_user and channel='formal';
  update public.arena_rewards set user_id=new_user where user_id=old_user and channel='formal';
