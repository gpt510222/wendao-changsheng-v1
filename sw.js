...
const NETWORK_FIRST_ASSETS = new Set(['index.html','arena.js','immortal-potential-system.js','game.js','production-rows.js','partner-system.js','styles.css','q-style.css','production-fix.css']);
